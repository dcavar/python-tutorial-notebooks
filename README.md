...
- [Pulling papers and meta-information from Arxiv](notebooks/arxiv_api_example.ipynb)
- [Convert the Stanford Sentiment Treebank Data to CSV](notebooks/Stanford_Sentiment_Treebank_Converter.ipynb)


### Text Classification

- [Simple Transformer-based Text Classification](notebooks/Transformers_example_simple_text_classification.ipynb)
- [Bayesian Classification for Machine Learning for Computational Linguistics](notebooks/Bayesian%20Classifier.ipynb)
- [Scikit-learn Logistic Regression 1](notebooks/Scikitlearn_logistic_regression.ipynb)
- [Scikit-learn Logistic Regression 2](notebooks/Scikitlearn_logistic_regression_2.ipynb)
- [Simple Feed Forward Network 1](notebooks/SimpleFeedForwardNetwork.ipynb)
- [Simple Feed Forward Network 2](notebooks/SimpleFeedForwardNetwork_2.ipynb)
...
- [spaCy Tutorial](notebooks/spaCy%20Tutorial.ipynb)
- [spaCy 3.x Tutorial: Transformers Spanish](notebooks/spaCy%203.x%20Tutorial%20Transformers%20Spanish.ipynb)
- [spaCy Named Entity Recognition Bootstrapping Model](notebooks/spaCy_NER_training.ipynb)
- [spaCy Model from CoNLL Data](notebooks/spaCy_CoNLL_Training.ipynb)
- [Train spaCy Model for Marathi (mr)](notebooks/Marathi/train_model.ipynb)
- [Linear Algebra and Embeddings - spaCy](notebooks/Embeddings_and_Vectors.ipynb)


#### NLTK Notebooks

- [NLTK: Texts and Frequencies - N-gram models and frequency profiles](notebooks/Python%20NLTK%20-%20Texts%20and%20Frequencies.ipynb)
- [Parsing with NLTK](notebooks/Python%20Parsing%20with%20NLTK.ipynb)
- [Parsing with NLTK and Foma](notebooks/Python%20Parsing%20with%20NLTK%20and%20Foma.ipynb)
- [Categorial Grammar Parsing in NLTK](notebooks/Combinatory%20Categorial%20Grammar%20Parsing%20with%20NLTK.ipynb)
- [Dependency Grammar in NLTK](notebooks/Dependency%20Grammar%20in%20NLTK.ipynb)
- [Document Classification Tutorial 1 - Amazon Reviews](notebooks/Document%20Classification%20Tutorial.ipynb)
- [WordNet using NLTK](notebooks/Python%20WordNet%20using%20NLTK.ipynb)
- [WordNet and NLTK](notebooks/WordNet%20and%20NLTK.ipynb)
- [Framenet in NLTK](notebooks/NLTK_Framenet.ipynb)
...
- [Extracting Abbreviations](notebooks/Abbreviations_extraction.ipynb)
- [TextRank Example](notebooks/textrank_example.ipynb)
...
- [Computing Finite State Automata](notebooks/Non-Deterministic%20Automaton%20Computing.ipynb)
- [Parallel Processing on Multiple Threads](notebooks/Parallelization_Example.ipynb)
- [Perceptron Learning in Python](notebooks/Perceptron%20Learning%20in%20Python.ipynb)
- [Clustering with Scikit-learn](notebooks/Python%20Clustering%20with%20Scikit-learn.ipynb)
- [Simple Language ID with N-grams](notebooks/Python%20Language%20ID.ipynb)
